...
def main():
	parser = argparse.ArgumentParser(description="convert .pth to .wts", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
	parser.add_argument("-i", "--input", type=str, help="path containing .pth files") # changed
	parser.add_argument("-o", "--output", type=str, help="path containing .wts files") # changed
	parser.add_argument(
		"-n", "--model_name", type=str, help="Model names", default="RealESRGAN_x4plus",
	...
	parser.add_argument("--fp32", action="store_true", help="Use full precision during inference")
	parser.add_argument("-v", "--verbose", action="store_true", help="print all checkpoint values") # added
